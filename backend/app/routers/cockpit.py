    ...
    kpis = [
        {
            ...
            "sales_amount": round(total_order_value, 2),
            "sales_ratio": round(total_contrib / total_order_value * 100, 1) if total_order_value else 0,
        },
        {
            "id": 2,
            "name": "🤖 AI贡献值",
        ...
        },
        {
            ...
            "unit": "%",
            "trend_text": f"满意 {very_good + good} · 不满意 {bad + very_bad}",
            "trend_class": "bg-green-50 text-success",
            "desc": f"非常满意{very_good} · 一般{normal} · 共{total_sessions}个会话",
