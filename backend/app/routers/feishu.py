...
def _mock_records(table_id: str) -> dict:
    mock_data = {
        ...
        "product": [
            {"SKU": "685181334733", "库存": 500, "规格": "多钩排", "尺寸": "标准款", "材质": "不锈钢烤漆"},
            {"SKU": "696228242482", "库存": 300, "规格": "标准款", "尺寸": "食品级接触用", "材质": "不锈钢+硅胶"},
        ],
        "session": [
        ...
        "order": [
            {"订单ID": "TB202401001", "用户ID": "李先生", "SKU": "厨房挂钩免打孔挂杆", "订单金额": 29.9, "状态": "已发货", "物流": "运输中", "退款状态": "无"},
        ],
        "action": [
            {"AI回复": "您好，这款厨房挂钩不锈钢烤漆承重强...", "转人工原因": "复杂问题", "人工处理结果": "已解决", "优惠动作": "未使用"},
        ],
        "event": [
